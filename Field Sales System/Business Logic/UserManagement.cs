...
namespace Field_Sales_System.Business_Logic
{
    ...
    {
        string addUser(ObjectFactory factory, int empId, int empNIC, bool gender, string firstName, string lastName, int mobileNo, int landNo, string email, string addressLine_1, string addressLine_2, string addressLine_3, Image img, string userType);
